...
public class ContinentGraphDeath implements Initializable {
    ...
    private ObservableList<XYChart.Series<String,Integer>> getData(){
        ...
        for (int i = 0; i < Controller.dateArray.size() ; i++) {
            asia.getData().add(new XYChart.Data<>(Controller.dateArray.get(i),Controller.asiaDeaths.get(i)));
            europe.getData().add(new XYChart.Data<>(Controller.dateArray.get(i),Controller.europeDeaths.get(i)));
            ocenian.getData().add(new XYChart.Data<>(Controller.dateArray.get(i),Controller.oceaniaDeaths.get(i)));
            america.getData().add(new XYChart.Data<>(Controller.dateArray.get(i),Controller.americaDeaths.get(i)));
            africa.getData().add(new XYChart.Data<>(Controller.dateArray.get(i),Controller.africaDeaths.get(i)));
